...
public class CustomerService
{
    public static void Run()
    {
        ...
        // Expected Result: New custimer will be added
        ...
        // Expected Result: dequeue the next customer from the queue and display the details
        Console.WriteLine("Test 3");
        cs.ServeCustomer();


        // Defect(s) Found: dequeues the second custumer
