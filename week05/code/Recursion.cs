...
public static class Recursion
{
    ...
    {
        // Initialize currPath if its not done yet
        if (currPath == null)
        {
        ...
        if (maze.IsEnd(x, y))
        {
            currPath.Add((x, y)); // Temporarily add end position
            results.Add(currPath.AsString()); // Store the formatted path
        ...
        // Remove last position before returning to previous recursion level
